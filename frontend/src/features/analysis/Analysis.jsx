...
const RECOMMENDED_PATHS = [
  {
    ...
    description: "Build a strong foundation in data analysis and machine learning",
    steps: [
      {
        ...
        reason: "Fills your Statistics gap. Required foundation before ML courses.",
      },
      {
        label: "Step 2 — Core",
        ...
        reason: "Addresses your biggest skill gap in Machine Learning. Builds on your Python strength.",
      },
      {
        ...
        reason: "Natural progression after ML fundamentals. Targets your Deep Learning gap.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        reason: "Core cloud concepts — essential for any cloud role.",
      },
      {
        label: "Step 2 — Core",
        title: "AWS Solutions Architect",
        org: "Amazon Web Services",
        skills: ["AWS", "Infrastructure as Code", "Security"],
        reason: "Most in-demand cloud certification. Covers architecture and security.",
      },
      {
        label: "Step 3 — DevOps",
        ...
        reason: "Container orchestration is critical for modern cloud deployments.",
      },
    ],
  },
  {
    ...
    description: "Combine ML expertise with production engineering skills",
    steps: [
      {
        label: "Step 1 — Foundation",
        ...
        reason: "Strengthen data engineering skills needed for ML pipelines.",
      },
      {
        label: "Step 2 — ML Systems",
        title: "MLOps & Model Deployment",
        org: "Google Cloud",
        skills: ["MLOps", "Model Serving", "Monitoring"],
        reason: "Learn to deploy and maintain ML models in production.",
      },
      {
        label: "Step 3 — Scale",
        title: "Distributed ML with Spark",
        org: "IBM",
        skills: ["Apache Spark", "Distributed Computing", "Big Data"],
        reason: "Scale ML workloads. Essential for enterprise ML engineering.",
      },
    ],
  },
  {
    ...
    description: "Develop data-driven product management skills",
    steps: [
      {
        label: "Step 1 — Foundation",
        ...
        reason: "Core PM skills including strategy and user-centered design.",
      },
      {
        label: "Step 2 — Data Skills",
        title: "Data Analysis for Business",
        org: "IBM",
        skills: ["Data Analysis", "Business Intelligence", "Dashboards"],
        reason: "Data literacy is essential for modern product decisions.",
      },
      {
        label: "Step 3 — Leadership",
        title: "Leading Teams & Innovation",
        org: "University of Michigan",
        skills: ["Leadership", "Communication", "Innovation"],
        reason: "Advance to senior PM roles with leadership and stakeholder management.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        label: "Step 1 — Frontend",
        title: "React & Modern JavaScript",
        org: "Meta",
        skills: ["React", "JavaScript", "TypeScript"],
        reason: "Most popular frontend framework. Strong job market demand.",
      },
      {
        ...
        reason: "Complete the full-stack skill set with server-side development.",
      },
      {
        label: "Step 3 — Deploy",
        ...
        reason: "Ship your apps to production with modern DevOps practices.",
      },
    ],
  },
];
